...
export function ChatInterface() {
  ...
  // Handle WebSocket AI responses
  useEffect(() => {
    if (lastMessage?.type === 'ai_response' && lastMessage.mentorId === selectedMentorId) {
      setIsTyping(false);
  ...
  }, [lastMessage, selectedMentorId, sendMessageMutation]);
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!messageInput.trim() || !selectedMentorId || !user) return;
