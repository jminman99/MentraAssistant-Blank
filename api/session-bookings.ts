...
import { createRequestContext, logLatency, createErrorResponse, applyRateLimit } from './_lib/middleware.js';
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    console.error(`[SESSION_BOOKINGS:${context.requestId}] Error:`, error);
